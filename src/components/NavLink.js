...
const NavLink = ({children,red,blue,green,yellow}) => {
    ...
    return(
        <div data-testid='link' className={`my-1 text-sm font-medium text-gray-700 transition-colors duration-200 transform dark:text-gray-200 ${hover} md:mx-4 md:my-0 capitalize`}>
            {children}
        </div>
    )
}
